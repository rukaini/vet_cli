...
if (session_status() === PHP_SESSION_NONE) {
    session_start(); // This "catches" the session
}

// Check if we have a Vet ID, otherwise redirect to login
if (!isset($_SESSION['vetID'])) {
    // Optional: Redirect to login if they try to access the header without logging in
    // header("Location: http://10.48.74.199:81/vetcli/login.php");
    // exit();
}
?>
           ...
           <nav id="navmenu" class="navmenu">
               <ul>
                   ...
                   <li class="dropdown"><a href="#"><span>Treatment</span> <i
                               class="bi bi-chevron-down toggle-dropdown"></i></a>
                       <ul>
                           <li><a href="/vet_cli/frontend/treatment_view.php">Add Treatment</a></li>

                           <li><a href="/vet_cli/frontend/treatment2.php">List Treatment</a></li>
                       </ul>
                   </li>
